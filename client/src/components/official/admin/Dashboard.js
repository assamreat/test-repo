                        ...
                        <div className="card-body">
                            <div className="text-center">
                                <img
                                    ...
                                    style={{ width: '25rem' }}
                                    src={
                                        require('../../../assets/official/img/undraw_posting_photo.svg')
                                            .default
                                    }
                                    alt="..."
                                />
                    ...
                    <div className="card shadow mb-4">
                        ...
                        <div className="card-body">
                            <p>
                                ...
                                utility classNamees in order to reduce CSS bloat
                                and poor page performance. Custom CSS
                                classNamees are used to create custom components
                                and custom utility classNamees.
                            </p>
                            <p className="mb-0">
                                Before working with this theme, you should
                                become familiar with the Bootstrap framework,
                                especially the utility classNamees.
                            </p>
                        </div>
                    </div>
                </div>
