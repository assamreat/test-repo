                        ...
                        >
                            <div className="dropdown-list-image mr-3">
                                <img
                                    ...
                                    src={
                                        require('../../../assets/official/img/undraw_profile_1.svg')
                                            .default
                                    }
                                    alt="..."
                                />
                        ...
                        >
                            <div className="dropdown-list-image mr-3">
                                <img
                                    className="rounded-circle"
                                    src={
                                        require('../../../assets/official/img/undraw_profile_2.svg')
                                            .default
                                    }
                                    alt="..."
                                />
                ...
                <li className="nav-item dropdown no-arrow">
                    ...
                    >
                        ...
                        <img
                            ...
                            alt="profile"
                            src={
                                require('../../../assets/official/img/undraw_profile.svg')
                                    .default
                            }
                        />
                    </Link>
